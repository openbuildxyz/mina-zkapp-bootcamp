...
import { CrowedFunding, MINA } from './CrowedFunding';
...
describe('CrowedFunding', () => {
    ...
    const prepare = async () => {
        ...
        const zkApp = new CrowedFunding(zkAppAccount.toPublicKey());
        ...
        await tx.prove();
        await tx.sign([deployer.key, zkAppAccount]).send();
