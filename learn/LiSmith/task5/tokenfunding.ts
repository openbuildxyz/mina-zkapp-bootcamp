...
export class TokenFunding extends SmartContract {
	events = {
		"payer": PublicKey,
		"receiver": PublicKey,
		"amount": UInt64
	...
	@method async fund(amount: UInt64) {
		...
		const upd  = senderUpdate.send({ to: this, amount: realfund })
		upd.body.mayUseToken = AccountUpdate.MayUseToken.InheritFromParent;
