import { DeployArgs, method, PublicKey, SmartContract, state, State, UInt32, UInt64, Permissions, Provable, assert, AccountUpdate } from "o1js";
...
export class Crowdfunding extends SmartContract {
    ...
    @method async buyFungiableToken(seller: PublicKey, buyer: PublicKey, amount: UInt64) {
        await this.validate(seller, buyer, amount);
