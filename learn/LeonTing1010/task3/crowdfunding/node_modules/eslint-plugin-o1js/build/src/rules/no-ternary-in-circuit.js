...
const rule = {
    meta: {
        messages: {
            noTernaryInCircuit: 'A "ternary" statement should not be used in a circuit. Please use "Circuit.if" instead.',
        },
        schema: [],
        type: 'suggestion',
        docs: {
            description: 'A "ternary" statement should not be used in a circuit. Please use "Circuit.if" instead.',
            recommended: 'warn',
        },
    },
    create(context) {
        ...
        function callsTernary(functionName) {
            var _a;
            return (ternarySet.has(functionName) ||
                !!((_a = callees[functionName]) === null || _a === void 0 ? void 0 : _a.some(callsTernary)));
        }
        return {
            'Program:exit': function () {
                for (const circuitNode of o1CircuitMap.values()) {
                    (0, typescript_estree_1.simpleTraverse)(circuitNode, {
                        enter: (node) => {
                            if ((0, node_utils_1.isConditionalExpression)(node)) {
                                context.report({
...
module.exports = rule;
//# sourceMappingURL=no-ternary-in-circuit.js.map